...
![R2 show crypto ikev2 sa](IMAGEN3.png)
...
![R2 show crypto session y show crypto ipsec sa](IMAGEN4.png)
...
![R2 show running-config section crypto](IMAGEN5.png)
...
![R3 show crypto ikev2 sa y show crypto session](IMAGEN8.png)
...
![R3 show running-config section crypto](IMAGEN10.png)
...
![VPC9 ping 10.15.99.3](IMAGEN11.png)
